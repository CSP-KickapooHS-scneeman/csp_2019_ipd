...
modules = [example0, example1, example2, example3, example4, example5, example6, team_neeman, Team_Aiden, team_wayne, team_conner, team_Quinten, team_gavinA, team_chris]
